/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/Users/minoru/Dev/Case/AnimalHospital/AnimalEkarte/backend/wrangler.jsonc` (hash: 1bf092f32ddddfe8e7fbf6229b7e078c)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_compat_v2
interface __BaseEnv_Env {
	...
	SMTP_PORT: "587";
	SMTP_FROM: "noreply@noah-karte.com";
	STORAGE_TYPE: "s3";
	S3_BUCKET: "animalekarte-stg-images";
	S3_REGION: "auto";
	S3_SHARED_BUCKET: "animalekarte-stg-images";
	S3_SHARED_REGION: "auto";
	S3_ENDPOINT: "https://776ddc3e975e8fe5773d5300522e2404.r2.cloudflarestorage.com";
	DB_HOST: string;
	DB_USER: string;
	DB_PASSWORD: string;
	AWS_ACCESS_KEY_ID: string;
	AWS_SECRET_ACCESS_KEY: string;
	MIGRATE_RUN_SECRET: string;
	JWT_SECRET: string;
	...
	API_CONTAINER: DurableObjectNamespace<import("./backend/worker/index").AnimalEkarteApiContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/worker/index");
		durableNamespaces: "AnimalEkarteApiContainer";
	}
