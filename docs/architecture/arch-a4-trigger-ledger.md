...
|-----------|-------------------|----------|----------|
| **lstep** | LINE 再開 #259 直前 | STATUS: #259 **依存待ち**（先方 enable 後） | **blocked** |
...
| **A4-billing-S3** | Extract estimate successor path to `estimate_service_successor.go` (598 → ~475 + 137, behavior unchanged) | (this PR) |
