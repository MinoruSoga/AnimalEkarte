...
| 6 | スタッフアカウント発行・権限設定済み | #255 | 全スタッフに個人アカウント発行・所属院スコープ・役割別権限設定済み | （確定待ち: 現在版名簿・email/院/役割方針と認可 apply 証跡。過去の受領履歴と区別し、[発行手順 I-ROSTER](../ops/deploy/STAFF_ACCOUNT_PROVISIONING.md#不足入力チェックリスト2026-08-20) を確認） |
