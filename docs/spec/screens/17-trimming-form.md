...
## 概要
- **画面の目的**: トリミング施術の詳細（コース、オプション、カットスタイル、身体状態）の精緻な記録、および画像管理。
- **URLパターン**: 
...
### 1.2 画像管理
- **希望スタイル画像**: 飼い主の要望・参考写真をアップロード。
- **完成画像**: 施術完了後の仕上がり写真をアップロード。

### 1.3 過去履歴の参照と引用 (History Sync)
- **履歴パネル**: 画面右側に同ペットの過去の施術記録を表示。
- **コピー機能**: 履歴カードをクリックすると、コース・オプション・スタイル要望・使用シャンプー/リボン・備考・担当スタッフを現在のフォームへ一括反映。常連顧客の再オーダーの手間を削減します。
...
- **`TrimmingImageUploadField`**: 希望スタイル画像・完成画像のアップロードUI。
