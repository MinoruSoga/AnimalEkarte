...
- **B⑤ cash_register + report handler系**: cash_register(+close) service/handler + accounting_report_service/handler + report request/response（reports repo/serviceはB④で合流済み）。DTO alias 18型の解消先。
