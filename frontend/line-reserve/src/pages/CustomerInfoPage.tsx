    ...
    <div className="min-h-screen bg-noah-teal-light flex flex-col">
      <div className="max-w-md mx-auto w-full flex flex-col flex-1">
        ...
        <div className="flex-1 px-4 space-y-4">
          ...
          <div>
            <label htmlFor="pet-name" className="block text-sm font-medium text-noah-text-sub mb-1">
              ペット名
            </label>
            <input
              id="pet-name"
          ...
          <div>
            <label htmlFor="pet-type" className="block text-sm font-medium text-noah-text-sub mb-1">
              ペット種類
            </label>
            <input
              id="pet-type"
