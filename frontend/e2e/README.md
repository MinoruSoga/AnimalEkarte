...
| `medical-records-pagination-sort.spec.ts` | /medical-records ページネーション(page=2 遷移)・列ソート(飼主名 desc→asc, URL 状態)・ステータスフィルタ(確定済, NotionFilter) — bug.md B-1 follow-up (AC-3) |
