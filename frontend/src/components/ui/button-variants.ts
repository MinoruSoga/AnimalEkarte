...
export const buttonVariants = cva(
  `inline-flex min-h-11 min-w-11 items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 ${C.focusVisibleRingActionPrimary} focus-visible:ring-offset-1 focus-visible:ring-offset-background`,
  {
    variants: {
      variant: {
