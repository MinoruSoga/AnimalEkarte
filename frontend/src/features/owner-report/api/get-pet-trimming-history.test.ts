...
describe("selectCompletedTrimmingHistory", () => {
  it("施術実施済み(完了)のみを残し、予約・キャンセル・進行中を除外する", () => {
    const items: TrimmingUI[] = [
      transformTrimming(
        bt({ id: 1, status: "completed", start_time: "2026-06-10T10:00:00+09:00" }),
      ),
      transformTrimming(
        bt({ id: 2, status: "cancelled", start_time: "2026-06-11T10:00:00+09:00" }),
      ),
      transformTrimming(
        bt({ id: 3, status: "confirmed", start_time: "2026-06-12T10:00:00+09:00" }),
      ),
      transformTrimming(
        bt({ id: 4, status: "in_consultation", start_time: "2026-06-13T10:00:00+09:00" }),
      ),
  ...
  it("完了を実施日の降順に並べる", () => {
    const items: TrimmingUI[] = [
      transformTrimming(
        bt({ id: 1, status: "completed", start_time: "2026-02-01T10:00:00+09:00" }),
      ),
      transformTrimming(
        bt({ id: 2, status: "completed", start_time: "2026-05-20T10:00:00+09:00" }),
      ),
      transformTrimming(
        bt({ id: 3, status: "completed", start_time: "2026-03-15T10:00:00+09:00" }),
      ),
    ];
