...
export const CATEGORY_CONFIG: Record<MasterSettingsCategory, CategoryConfig> = {
  examination: {
    ...
    namePlaceholder: "血液検査(CBC)", codePlaceholder: "",
  },
  vaccine: {
    label: "予防接種マスタ",
    ...
    labels: { code: "コード", name: "名称", category: "分類" },
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "狂犬病ワクチン", codePlaceholder: "",
  },
  medicine: {
    label: "薬剤マスタ",
    ...
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "アモキシシリン", codePlaceholder: "",
  },
  consultation: {
    label: "診察マスタ",
  ...
  procedure: {
    ...
    labels: { code: "コード", name: "名称", category: "分類" },
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "爪切り", codePlaceholder: "",
  },
  hospitalization: {
    label: "入院マスタ",
    ...
    labels: { code: "コード", name: "名称", category: "分類" },
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "入院料(小型)", codePlaceholder: "",
  },
  cage: {
    label: "ケージマスタ",
    ...
    showPrice: false, showCode: true, showCategory: true, showParentItem: false,
    namePlaceholder: "ICU-1", codePlaceholder: "ICU-01",
  },
  trimming_course: {
    label: "トリミングコースマスタ",
    ...
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "シャンプーコース(小型)", codePlaceholder: "",
  },
  trimming_option: {
    label: "トリミングオプションマスタ",
    ...
    showPrice: true, showCode: false, showCategory: false, showParentItem: true,
    namePlaceholder: "薬用シャンプー", codePlaceholder: "",
  },
  staff: {
    label: "スタッフマスタ",
    ...
    showPrice: false, showCode: false, showCategory: false, showParentItem: false,
    namePlaceholder: "山田 太郎", codePlaceholder: "ST-001",
  },
  insurance: {
    label: "保険マスタ",
  ...
  diagnosis_category: {
    ...
    namePlaceholder: "消化器疾患", codePlaceholder: "",
  },
  diagnosis_name: {
    label: "診断名マスタ",
    ...
    showPrice: false, showCode: false, showCategory: true, showParentItem: false,
    namePlaceholder: "食道炎", codePlaceholder: "",
  },
  checkup: {
    label: "定期健診マスタ",
