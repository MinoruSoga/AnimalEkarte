...
export function validateDoseParamForm(form: DoseParamFormData): DoseParamValidationResult {
  ...
  if (dosePerKg !== undefined && minMgPerKg !== undefined && dosePerKg < minMgPerKg) {
    errors.push("投与量は下限以上にしてください");
  }
  if (dosePerKg !== undefined && maxMgPerKg !== undefined && dosePerKg > maxMgPerKg) {
...
export function buildUpsertDoseParamRequest(
  form: DoseParamFormData,
): UpsertMedicineDoseParamRequest {
