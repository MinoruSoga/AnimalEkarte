  ...
  return (
    <div className={`flex flex-1 overflow-hidden relative manual-root ${C.bgPage}`}>
      ...
      <button
        ...
        className={`md:hidden fixed top-3 left-16 z-30 size-10 flex items-center justify-center rounded-xxs border ${C.borderDivider} ${C.bgWhite} ${C.hoverBgLight} no-print`}
      >
      ...
      {article && !editMode ? (
        <button
          ...
          className={`fixed top-3 right-16 z-30 size-10 flex items-center justify-center rounded-xxs border ${C.borderDivider} ${C.bgWhite} ${C.hoverBgLight} no-print`}
        >
      ...
      {article && !editMode ? (
        <button
          ...
          aria-label="このページを印刷"
          title="このページを印刷"
          className={`fixed top-3 right-3 z-30 size-10 flex items-center justify-center rounded-xxs border ${C.borderDivider} ${C.bgWhite} ${C.hoverBgLight} no-print`}
        >
        ...
        <>
          ...
          <div className="md:hidden fixed inset-y-0 left-0 z-50 flex no-print">
            ...
            <button
              ...
              onClick={() => setDrawerOpen(false)}
              aria-label="ドロワーを閉じる"
              className={`size-10 m-2 flex items-center justify-center rounded-xxs ${C.bgWhite} border ${C.borderDivider}`}
            >
              <X className="size-5" />
            </button>
          </div>
