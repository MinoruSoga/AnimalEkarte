...
export const ExaminationGroup = memo(function ExaminationGroup({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`min-w-[600px] grid grid-cols-[2fr_1.5fr_1.5fr_2fr_1.5fr] gap-0 border-b ${C.borderMedium} ${C.bgPage} ${STYLE.sectionLabel} h-12 items-center`}
        >
        ...
        {group.items.map((item, idx) => (
          ...
          >
            <div className={`p-2 border-r ${C.borderMedium} pl-3 font-medium`}>{item.name}</div>
            <div
