...
export type DoseGateSource =
  { kind: "ready"; input: DoseCalcInput } | { kind: "missing" } | { kind: "technical_failure" };
 ...
 */
export function computeDoseGate(source: DoseGateSource, submittedQty: number): DoseGateResult {
