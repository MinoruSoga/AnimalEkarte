...
import type { CheckupFieldType } from "./get-checkup-type-fields";
...
function transform(r: PetCheckupResultApi): PetCheckupResult {
  return {
    id: r.id,
...
export const useGetPetCheckupResults = (petId?: string) => {
  return useQuery({
    queryKey: ["pet-checkup-results", "report", petId],
