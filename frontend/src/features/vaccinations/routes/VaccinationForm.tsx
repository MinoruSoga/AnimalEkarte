...
const VaccinationFormFields = memo(function VaccinationFormFields({
  ...
  return (
    <div className="col-span-1 lg:col-span-6 flex flex-col gap-4">
      <div className={`bg-white rounded-lg p-4 border ${C.borderMedium} shadow-sm space-y-4`}>
        {/* Vaccination Form Fields (Matching MedicalRecordVaccination) */}
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <Label className={`text-sm ${C.text60}`}>予防接種名</Label>
            <Select value={vaccineId} onValueChange={onVaccineIdChange}>
              <SelectTrigger className={`h-10 text-sm bg-white ${C.borderMedium} ${C.text}`}>
        ...
        {/* Supplemental */}
        <div className="flex flex-col gap-1.5">
          <Label className={`text-sm ${C.text60}`}>補助説明</Label>
          <Input
            value={supplemental}
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="flex flex-col gap-1.5">
            <Label className={`text-sm ${C.text60}`}>LOT1</Label>
            <Input
              value={lot1}
          ...
          <div className="flex flex-col gap-1.5">
            <Label className={`text-sm ${C.text60}`}>LOT2</Label>
            <Input
              value={lot2}
          ...
          <div className="flex flex-col gap-1.5">
            <Label className={`text-sm ${C.text60}`}>LOT3</Label>
            <Input
              value={lot3}
          ...
          <div className="flex flex-col gap-1.5">
            <Label className={`text-sm ${C.text60}`}>LOT4</Label>
            <Input
              value={lot4}
        ...
        {/* Next Schedule Type */}
        <div className="flex flex-col gap-1.5">
          <Label className={`text-sm ${C.text60}`}>次回予防接種予定設定</Label>
          <RadioGroup
          ...
          >
            <div className="flex items-center space-x-1.5">
              <RadioGroupItem value="3weeks" id="r1" className={C.text} />
              <Label htmlFor="r1" className={`font-normal text-sm ${C.text}`}>3週間後</Label>
            </div>
            <div className="flex items-center space-x-1.5">
              <RadioGroupItem value="4weeks" id="r2" className={C.text} />
              <Label htmlFor="r2" className={`font-normal text-sm ${C.text}`}>4週間後</Label>
            </div>
            <div className="flex items-center space-x-1.5">
              <RadioGroupItem value="1year" id="r3" className={C.text} />
              <Label htmlFor="r3" className={`font-normal text-sm ${C.text}`}>1年後</Label>
            </div>
            <div className="flex items-center space-x-1.5">
              <RadioGroupItem value="other" id="r4" className={C.text} />
              <Label htmlFor="r4" className={`font-normal text-sm ${C.text}`}>以外</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        <div className="flex flex-col gap-1.5 flex-1">
          <Label className={`text-sm ${C.text60}`}>備考</Label>
          <Textarea
            value={remarks}
            onChange={onRemarksChange}
            className={`resize-none bg-white ${C.borderMedium} min-h-[100px] text-sm ${C.text}`}
          />
        </div>
      </div>
    </div>
...
const HistorySection = memo(function HistorySection({
  ...
  return (
    <div className="col-span-1 lg:col-span-6 flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex gap-2">
            <Input
              ...
              placeholder="検索..."
            />
            <Button variant="outline" className={`h-10 text-sm ${C.borderMedium} ${C.text60} ${C.hoverBgPage}`}>
              クリア
            </Button>
      ...
      {/* Table */}
      <div className={`border ${C.borderMedium} rounded-lg bg-white overflow-hidden flex flex-col min-h-[400px]`}>
        {/* Header */}
              ...
              <div key={item.id} className={`flex items-center border-b ${C.borderMedium} bg-white text-sm ${C.text} h-10 ${C.hoverBgPage}`}>
                ...
                <div className={`w-[80px] px-2 flex justify-center border-l ${C.borderMedium}`}>
                  <Button
                    variant="outline"
                    size="sm"
                    className={`h-10 w-[50px] text-sm ${C.borderMedium} ${C.text60} ${C.hoverBgPage} px-0`}
                  >
                    複製
                  </Button>
                </div>
