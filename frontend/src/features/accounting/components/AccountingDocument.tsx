          ...
          return (
            <div key="owner_pet_info" className="flex justify-between items-start">
              <div className="space-y-1">
                ...
                <div className={`text-xl border-b ${C.printBorder} mb-2 pb-1 inline-block min-w-[250px]`}>
          ...
          return (
            <div key="items_table">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className={`border-b-2 ${C.printBorder}`}>
          ...
          return (
            <div key="payment_summary" className="flex justify-end">
              <div className="w-72 space-y-2">
                ...
                <div className={`flex justify-between font-bold text-xl pt-2 border-t ${C.printBorder}`}>
                  <span>請求金額</span>
