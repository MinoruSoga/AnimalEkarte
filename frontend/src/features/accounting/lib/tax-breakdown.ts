...
type TaxBreakdownItem = Pick<
  AccountingItem,
  "unitPrice" | "quantity" | "discountAmount" | "taxRate"
>;

/** 記録された明細ネット。移行の負額は 0 にクランプしない。 */
export function recordedLineNet(
  item: Pick<AccountingItem, "unitPrice" | "quantity" | "discountAmount">,
): number {
