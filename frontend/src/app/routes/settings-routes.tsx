...
export const settingsRoute: RouteObject = {
  ...
  children: [
    ...
    {
      path: "service-type",
      element: <Navigate to={paths.settings.reservationType.getHref()} replace />,
    },
    {
      path: "diagnosis-type",
      element: <Navigate to={paths.settings.diagnosisType.getHref()} replace />,
    },
    {
      path: "diagnosis-name",
      element: <Navigate to={paths.settings.diagnosisName.getHref()} replace />,
    },
    {
      path: "trimming-course",
      element: <Navigate to={paths.settings.trimmingCourse.getHref()} replace />,
    },
    {
      path: "trimming-option",
      element: <Navigate to={paths.settings.trimmingOption.getHref()} replace />,
    },
    {
      path: "examination",
      element: <Navigate to={paths.settings.examination.getHref()} replace />,
    },
    { path: "vaccine", element: <Navigate to={paths.settings.vaccine.getHref()} replace /> },
    {
      path: "consultation",
      element: <Navigate to={paths.settings.consultation.getHref()} replace />,
    },
    { path: "procedure", element: <Navigate to={paths.settings.procedure.getHref()} replace /> },
    {
      path: "inquiry-template",
      element: <Navigate to={paths.settings.inquiryTemplates.getHref()} replace />,
    },
    {
      path: "staff",
      element: (
        <RequirePermission resource={ResourceMasterStaff}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      ...
      element: (
        <RequirePermission resource={ResourceMasterMedical}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      path: "animal-species",
      element: (
        <RequirePermission resource={ResourceMasterAnimalSpecies}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      path: "trimming",
      element: (
        <RequirePermission resource={ResourceMasterTrimming}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      ...
      element: (
        <RequirePermission resource={ResourceMasterHospitalization}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      ...
      element: (
        <RequirePermission resource={ResourceMasterMerchandise}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      path: "insurance",
      element: (
        <RequirePermission resource={ResourceMasterInsurance}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    },
    {
      ...
      element: (
        <RequirePermission resource={ResourceMasterPermission}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    // フィルタしているが、URL 直叩きで権限なしユーザーが到達できる脆弱性を塞ぐ。
    {
      path: "closing-time",
      element: (
        <RequirePermission resource={ResourceClosingSettings}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
    ...
    // STG-BLOCKER-002: RequirePermission 追加（理由は closing-time と同じ）
    {
      ...
      element: (
        <RequirePermission resource={ResourcePaymentMethod}>
          <Outlet />
        </RequirePermission>
      ),
      children: [
