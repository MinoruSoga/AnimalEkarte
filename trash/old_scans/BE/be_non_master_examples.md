# BE 業務系（非マスタ）コード規約対応 プロンプト例

チェックリスト仕様: `tmp/BE/be_non_master_check.md`
...
### Team-Routes
担当: P5/P6 — handler/handler.go の register*RoutesWithAuth および各ハンドラの Register*Routes（パーミッション設定）修正タスク全件
