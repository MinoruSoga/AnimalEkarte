...
| カテゴリ | 主要ドキュメント |
|:---|:---|
| **作業台帳（進行中）** | **Linear**（hub [BRT-4](https://linear.app/baritechllc/issue/BRT-4)）· 入口 [todo.md](todo.md) / [todo.md#human-lane](todo.md#human-lane)（ポインタのみ）· [docs/work/](docs/work/README.md) |
