...
func (r *examTypeRepository) Update(ctx context.Context, clinicID, id uint64, fields map[string]any) (*model.ExaminationType, error) {
	if err := updateScopedByID(ctx, r.db, &model.ExaminationType{}, "examination_type", clinicID, id, fields); err != nil {
		return nil, err
	}
...
func (r *examTypeRepository) Delete(ctx context.Context, clinicID, id uint64) error {
	return deleteScopedByID(ctx, r.db, &model.ExaminationType{}, "examination_type", clinicID, id)
}

func (r *examTypeRepository) Reorder(ctx context.Context, clinicID uint64, ids []uint64) error {
	return reorderByClinicID(ctx, r.db, &model.ExaminationType{}, "examination_type", clinicID, ids, "sort_order")
}
