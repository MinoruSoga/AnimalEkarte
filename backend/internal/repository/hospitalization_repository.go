...
type HospitalizationRepository interface {
	FindAll(ctx context.Context, status *string, page, limit int) ([]model.Hospitalization, int64, error)
	FindByID(ctx context.Context, id uuid.UUID) (*model.Hospitalization, error)
...
func (r *hospitalizationRepository) FindAll(ctx context.Context, status *string, page, limit int) ([]model.Hospitalization, int64, error) {
	var hospitalizations []model.Hospitalization
	var total int64

	q := r.db.WithContext(ctx).Model(&model.Hospitalization{})
	if status != nil {
...
func (r *hospitalizationRepository) FindByID(ctx context.Context, id uuid.UUID) (*model.Hospitalization, error) {
...
func (r *hospitalizationRepository) Delete(ctx context.Context, id uuid.UUID) error {
	if err := r.db.WithContext(ctx).Delete(&model.Hospitalization{}, "id = ?", id).Error; err != nil {
		return apperrors.Wrap(err, "delete hospitalization")
	}
	return nil
}
