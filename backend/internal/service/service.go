...
func NewServices(repos *repository.Repositories, notifCfg *ReservationNotificationConfig) *Services {
	...
	return &Services{
		...
		Reservation:                    NewReservationService(repos.Reservation, tx, repos.ReservationStaff),
		...
		ReservationAdmin:          NewReservationAdminService(repos.ReservationAdmin, repos.Reservation, tx, repos.ReservationStaff),
