...
func NewServices(repos *repository.Repositories, notifCfg *ReservationNotificationConfig, cipher *crypto.AESGCMCipher, sharedStorage infra.FileStorage, jwtSecret string) *Services {
	...
	return &Services{
		...
		Hospitalization:       NewHospitalizationService(repos.Hospitalization, repos.Reservation, repos.Pet, repos.Cage, repos.CarePlanItem, repos.Accounting, repos.BillingItem, tx),
