...
func NewServices(repos *repository.Repositories, notifCfg *ReservationNotificationConfig) *Services {
	...
	return &Services{
		...
		CarePlanItem:                   NewCarePlanItemService(repos.CarePlanItem, repos.Hospitalization),
		...
		ClinicalPlan:                   NewClinicalPlanService(repos.ClinicalPlan, repos.MedicalRecord),
