...
func (m *mockMedRecordRepoForLstepVisit) FindAll(_ context.Context, _ []uint64, _, _ *uint64, _, _ *string, _, _ int) ([]model.MedicalRecord, int64, error) {
	return nil, 0, nil
}
...
func (m *mockMedRecordRepoForLstepVisit) Update(_ context.Context, _, _ uint64, _ map[string]any) (*model.MedicalRecord, error) {
	return nil, nil
}
