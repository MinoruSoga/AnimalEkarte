...
func (m *mockDeliveryTriggerLogRepository) FindAllByOwnerAndDateRange(_ context.Context, _, _ uint64, _, _ time.Time) ([]model.LstepDeliveryTriggerLog, error) {
	return nil, nil
}
...
func (m *mockOwnerRepoForDelivery) FindAllByLineUserID(_ context.Context, _ string) ([]model.Owner, error) {
	return nil, nil
}
func (m *mockOwnerRepoForDelivery) UpdateLineFollowedAt(_ context.Context, _, _ uint64, _ time.Time) error {
	return nil
}
func (m *mockOwnerRepoForDelivery) UpdateLineBlockedAt(_ context.Context, _, _ uint64, _ time.Time) error {
	return nil
}
...
func (m *mockTagCacheRepoForDelivery) FindOwnersByTag(_ context.Context, _ uint64, _, _ string, _, _ int) ([]repository.TagOwnerRow, int64, error) {
	return nil, 0, nil
}
func (m *mockTagCacheRepoForDelivery) BulkReplaceOwnerTags(_ context.Context, _, _ uint64, _ []repository.TagEntry) error {
	return nil
}
...
func buildDeliverySvc(
	...
	billingRepo repository.BillingItemRepository,
	petRepo repository.PetRepository,
	tagRepo repository.LstepTagCacheRepository,
...
func TestLstepDeliveryTriggerService_TriggerFirstVisitFollowUp3D(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := buildDeliverySvc(ownerRepo, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, tagRepo, logRepo, settings)
...
func TestLstepDeliveryTriggerService_TriggerFirstVisitFollowUp7D(t *testing.T) {
	...
	svc := buildDeliverySvc(ownerRepo, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, enabledSettings())
	injectTestClient(svc, &mockLstepClientForDelivery{})
...
func TestLstepDeliveryTriggerService_TriggerVaccineDeadlines(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := buildDeliverySvc(ownerRepo, nil, vacRepo, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, enabledSettings())
			injectTestClient(svc, &mockLstepClientForDelivery{})
...
func TestLstepDeliveryTriggerService_TriggerBirthdayMessage(t *testing.T) {
	...
	svc := buildDeliverySvc(ownerRepo, nil, nil, defaultMockBillingItemRepoForDelivery(), petRepo, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, enabledSettings())
	injectTestClient(svc, &mockLstepClientForDelivery{})
...
func TestLstepDeliveryTriggerService_TriggerTagBased(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := buildDeliverySvc(ownerRepo, nil, nil, defaultMockBillingItemRepoForDelivery(), nil, tagRepo, &mockDeliveryTriggerLogRepository{}, enabledSettings())
			injectTestClient(svc, &mockLstepClientForDelivery{})
			count, errs := tt.triggerFn(svc, context.Background())
			assert.Equal(t, 1, count)
			assert.Empty(t, errs)
...
func TestLstepDeliveryTriggerService_SyncDisabled(t *testing.T) {
	...
	svc := buildDeliverySvc(&mockOwnerRepoForDelivery{}, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, disabledSettings())
...
func TestLstepDeliveryTriggerService_ExclTagStopsDelivery(t *testing.T) {
	...
	svc := buildDeliverySvc(ownerRepo, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, tagRepo, logRepo, enabledSettings())
	count, errs := svc.TriggerFirstVisitFollowUp3D(context.Background(), 1, time.Now())
	assert.Equal(t, 0, count)
	assert.Empty(t, errs)
...
func TestLstepDeliveryTriggerService_AlreadyFiredSkips(t *testing.T) {
	...
	svc := buildDeliverySvc(&mockOwnerRepoForDelivery{}, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, logRepo, enabledSettings())
	count, errs := svc.TriggerFirstVisitFollowUp3D(context.Background(), 1, time.Now())
	assert.Equal(t, 0, count)
	assert.Empty(t, errs)
}
...
func TestLstepDeliveryTriggerService_TriggerLogRecorded(t *testing.T) {
	...
	svc := buildDeliverySvc(ownerRepo, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, logRepo, enabledSettings())
	injectTestClient(svc, &mockLstepClientForDelivery{})
...
func TestLstepDeliveryTriggerService_TriggerFirstVisitWelcome(t *testing.T) {
	...
	t.Run("sync disabled returns nil (noop)", func(t *testing.T) {
		svc := buildDeliverySvc(&mockOwnerRepoForDelivery{}, &mockMedicalRecordRepository{}, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, disabledSettings())
	...
	t.Run("happy path fires tag for owner with line_user_id", func(t *testing.T) {
		...
		svc := buildDeliverySvc(ownerRepo, &mockMedicalRecordRepository{}, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, enabledSettings())
	...
	t.Run("buildClient error is returned", func(t *testing.T) {
		...
		svc := buildDeliverySvc(&mockOwnerRepoForDelivery{}, &mockMedicalRecordRepository{}, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, settingsSvc)
		err := svc.TriggerFirstVisitWelcome(context.Background(), 1, ownerID)
		assert.Error(t, err)
	})
...
func TestLstepDeliveryTriggerService_EmptyOwnerListIsNoop(t *testing.T) {
	...
	svc := buildDeliverySvc(&mockOwnerRepoForDelivery{}, medRepo, nil, defaultMockBillingItemRepoForDelivery(), nil, &mockTagCacheRepoForDelivery{}, &mockDeliveryTriggerLogRepository{}, enabledSettings())
	count, errs := svc.TriggerFirstVisitFollowUp3D(context.Background(), 1, time.Now())
	assert.Equal(t, 0, count)
	assert.Empty(t, errs)
}
