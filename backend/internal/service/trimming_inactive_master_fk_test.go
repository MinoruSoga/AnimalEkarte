...
func inactiveTrimmingCourseRepo() repository.TrimmingCourseRepository {
...
func inactiveTrimmingOptionRepo() repository.TrimmingOptionRepository {
...
func TestTrimmingService_Update_InactiveCourseFKGuard(t *testing.T) {
	...
	t.Run("rejects newly added inactive course_id on update and does not persist", func(t *testing.T) {
		...
		svc := NewTrimmingService(reserv, &mockTrimmingReservationTypeRepository{}, nil, nil, nil,
