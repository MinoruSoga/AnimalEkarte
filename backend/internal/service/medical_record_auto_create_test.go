...
func TestAutoCreateFromReservation_AdditionalBranches(t *testing.T) {
	...
	t.Run("reservation が nil の場合はパニックせず即座にスキップする", func(t *testing.T) {
		svc := NewMedicalRecordService(&mockMedicalRecordRepository{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
		assert.NotPanics(t, func() {
	...
	t.Run("owner_id/pet_idが既に設定済みならLINE補完なしで作成される", func(t *testing.T) {
		...
		svc := NewMedicalRecordService(repo, nil, nil, nil, clinicalPlanRepo, nil, nil, nil, nil, nil, nil, nil, nil)
