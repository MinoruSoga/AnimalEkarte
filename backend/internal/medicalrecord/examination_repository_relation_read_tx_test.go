...
func TestExaminationRepository_FindAllAndFindByJobIDJoinAmbientTx(t *testing.T) {
	...
	err := fixture.writeTransactor.WithTx(ctx, func(txCtx context.Context) error {
		...
		listed, total, findErr := repo.FindAll(txCtx, fixture.clinicA, nil, nil, nil, nil, nil, 1, 100)
	...
	listed, total, err := repo.FindAll(ctx, fixture.clinicA, nil, nil, nil, nil, nil, 1, 100)
