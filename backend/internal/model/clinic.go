...
type Clinic struct {
	...
	AccountingDocumentShowClinicHeader   bool           `gorm:"not null;default:true" json:"accounting_document_show_clinic_header"`
	AccountingDocumentShowOwnerPetInfo   bool           `gorm:"not null;default:true" json:"accounting_document_show_owner_pet_info"`
	AccountingDocumentShowItemsTable     bool           `gorm:"not null;default:true" json:"accounting_document_show_items_table"`
	AccountingDocumentShowPaymentSummary bool           `gorm:"not null;default:true" json:"accounting_document_show_payment_summary"`
	AccountingDocumentSectionOrder       pq.StringArray `gorm:"type:text[];not null;default:'{}'" json:"accounting_document_section_order"`
