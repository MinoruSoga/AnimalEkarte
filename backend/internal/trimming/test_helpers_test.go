...
// mockReservationStaffRepository is the trimming test consumer formerly carried by
// internal/service. Keep the complete reservation interface shape so the moved tests exercise
