...
type mockTrimmingCourseTypeService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error)
...
func (m *mockTrimmingCourseTypeService) Create(ctx context.Context, clinicID uint64, input *service.CreateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
	if m.createFn != nil {
...
func (m *mockTrimmingCourseTypeService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
	if m.updateFn != nil {
...
func newHandlerWithTrimmingCourseTypeSvc(svc service.TrimmingCourseTypeService) *Handler {
	return &Handler{svc: &service.Services{TrimmingCourseType: svc}}
}
...
func TestCreateTrimmingCourseType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingCourseTypeService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingCourseTypeService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
...
func TestUpdateTrimmingCourseType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingCourseTypeService{
				updateFn: func(_ context.Context, clinicID, id uint64, input *service.UpdateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingCourseTypeService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateTrimmingCourseTypeInput) (*model.TrimmingCourseType, error) {
					return nil, apperrors.WrapNotFound("trimming_course_type", "999")
				},
			},
			wantStatus: http.StatusNotFound,
