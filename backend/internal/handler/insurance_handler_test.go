...
type mockInsuranceService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateInsuranceInput) (*model.Insurance, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateInsuranceInput) (*model.Insurance, error)
...
func (m *mockInsuranceService) Create(ctx context.Context, clinicID uint64, input *service.CreateInsuranceInput) (*model.Insurance, error) {
	return m.createFn(ctx, clinicID, input)
}
func (m *mockInsuranceService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateInsuranceInput) (*model.Insurance, error) {
...
func newHandlerWithInsuranceSvc(svc service.InsuranceService) *Handler {
	return &Handler{
		svc: &service.Services{Insurance: svc},
	}
}
...
func TestCreateInsurance(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockInsuranceService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateInsuranceInput) (*model.Insurance, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockInsuranceService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateInsuranceInput) (*model.Insurance, error) {
...
func TestUpdateInsurance(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockInsuranceService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateInsuranceInput) (*model.Insurance, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockInsuranceService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateInsuranceInput) (*model.Insurance, error) {
					return nil, apperrors.WrapNotFound("insurance", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteInsuranceRouter(svc service.InsuranceService) *gin.Engine {
	r := gin.New()
...
func newReorderInsurancesRouter(svc service.InsuranceService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithInsuranceSvc(svc)
