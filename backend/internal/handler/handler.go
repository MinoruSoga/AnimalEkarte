...
func (h *Handler) RegisterRoutes(r *gin.Engine) {
	...
	v1.GET("/pets/:petId/medical-records", h.GetMedicalRecordsByPetID)
	v1.GET("/owners/:ownerId/medical-records", h.GetMedicalRecordsByOwnerID)
	...
	v1.GET("/pets/:petId/reservations", h.GetReservationsByPetID)
	v1.GET("/owners/:ownerId/reservations", h.GetReservationsByOwnerID)
	...
	v1.GET("/pets/:petId/hospitalizations", h.GetHospitalizationsByPetID)
	v1.GET("/owners/:ownerId/hospitalizations", h.GetHospitalizationsByOwnerID)
	...
	v1.GET("/pets/:petId/accountings", h.GetAccountingByPetID)
	v1.GET("/owners/:ownerId/accountings", h.GetAccountingByOwnerID)
	...
	v1.GET("/pets/:petId/examinations", h.GetExaminationsByPetID)
	v1.GET("/owners/:ownerId/examinations", h.GetExaminationsByOwnerID)
	...
	v1.GET("/pets/:petId/vaccinations", h.GetVaccinationsByPetID)
	v1.GET("/owners/:ownerId/vaccinations", h.GetVaccinationsByOwnerID)
	...
	v1.GET("/pets/:petId/trimmings", h.GetTrimmingsByPetID)
	v1.GET("/owners/:ownerId/trimmings", h.GetTrimmingsByOwnerID)
	...
	v1.GET("/clinics/:clinicId/staffs", h.GetStaffByClinicID)
