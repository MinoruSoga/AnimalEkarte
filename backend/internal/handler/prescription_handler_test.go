...
type mockPrescriptionService struct {
	...
	createFn  func(ctx context.Context, clinicID, medicalRecordID uint64, input *service.CreatePrescriptionInput) (*model.Prescription, error)
	updateFn  func(ctx context.Context, clinicID, medicalRecordID, prescriptionID uint64, input *service.UpdatePrescriptionInput) (*model.Prescription, error)
...
func (m *mockPrescriptionService) Create(ctx context.Context, clinicID, medicalRecordID uint64, input *service.CreatePrescriptionInput) (*model.Prescription, error) {
	return m.createFn(ctx, clinicID, medicalRecordID, input)
}

func (m *mockPrescriptionService) Update(ctx context.Context, clinicID, medicalRecordID, prescriptionID uint64, input *service.UpdatePrescriptionInput) (*model.Prescription, error) {
...
func newHandlerWithPrescriptionSvc(svc service.PrescriptionService) *Handler {
	return &Handler{svc: &service.Services{Prescription: svc}}
}
...
func TestCreatePrescription(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockPrescriptionService{
				createFn: func(_ context.Context, clinicID, medicalRecordID uint64, input *service.CreatePrescriptionInput) (*model.Prescription, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, uint64(1), medicalRecordID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockPrescriptionService{
				createFn: func(_ context.Context, _, _ uint64, _ *service.CreatePrescriptionInput) (*model.Prescription, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
...
func TestUpdatePrescription(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx:          func(c *gin.Context) { setClinicID(c) },
			svc: &mockPrescriptionService{
				updateFn: func(_ context.Context, clinicID, medicalRecordID, prescriptionID uint64, input *service.UpdatePrescriptionInput) (*model.Prescription, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, uint64(1), medicalRecordID)
		...
		},
		{
			...
			setupCtx:          func(c *gin.Context) { setClinicID(c) },
			svc: &mockPrescriptionService{
				updateFn: func(_ context.Context, _, _, _ uint64, _ *service.UpdatePrescriptionInput) (*model.Prescription, error) {
