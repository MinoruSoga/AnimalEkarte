...
type mockChronicConditionService struct {
	...
	createFn func(ctx context.Context, clinicID, petID uint64, input service.CreateChronicConditionInput) (*model.PetChronicCondition, error)
	updateFn func(ctx context.Context, clinicID, petID, id uint64, input service.UpdateChronicConditionInput) (*model.PetChronicCondition, error)
...
func (m *mockChronicConditionService) Create(
	ctx context.Context, clinicID, petID uint64, input service.CreateChronicConditionInput,
) (*model.PetChronicCondition, error) {
	return m.createFn(ctx, clinicID, petID, input)
}

func (m *mockChronicConditionService) Update(
	ctx context.Context, clinicID, petID, id uint64, input service.UpdateChronicConditionInput,
) (*model.PetChronicCondition, error) {
...
func newHandlerWithChronicConditionSvc(svc service.ChronicConditionService) *Handler {
	return &Handler{svc: &service.Services{ChronicCondition: svc}}
}
...
func TestCreateChronicCondition(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockChronicConditionService{
				createFn: func(_ context.Context, clinicID, petID uint64, input service.CreateChronicConditionInput) (*model.PetChronicCondition, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, uint64(3), petID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockChronicConditionService{
				createFn: func(_ context.Context, _, _ uint64, _ service.CreateChronicConditionInput) (*model.PetChronicCondition, error) {
...
func TestUpdateChronicCondition(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx:   func(c *gin.Context) { setClinicID(c) },
			svc: &mockChronicConditionService{
				updateFn: func(_ context.Context, clinicID, petID, id uint64, input service.UpdateChronicConditionInput) (*model.PetChronicCondition, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, uint64(3), petID)
		...
		},
		{
			...
			setupCtx:   func(c *gin.Context) { setClinicID(c) },
			svc: &mockChronicConditionService{
				updateFn: func(_ context.Context, _, _, _ uint64, _ service.UpdateChronicConditionInput) (*model.PetChronicCondition, error) {
...
func newDeleteChronicConditionRouter(svc service.ChronicConditionService) *gin.Engine {
	r := gin.New()
