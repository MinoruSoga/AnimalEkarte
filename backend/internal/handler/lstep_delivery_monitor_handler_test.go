...
type mockLstepDeliveryMonitorService struct {
	getSummaryFn func(ctx context.Context, input service.GetDeliveryMonitorSummaryInput) (service.DeliveryTriggerSummary, error)
	getLogsFn    func(ctx context.Context, input *service.GetDeliveryMonitorLogsInput) (service.DeliveryTriggerLogsPage, error)
}

func (m *mockLstepDeliveryMonitorService) GetSummary(ctx context.Context, input service.GetDeliveryMonitorSummaryInput) (service.DeliveryTriggerSummary, error) {
	return m.getSummaryFn(ctx, input)
}

func (m *mockLstepDeliveryMonitorService) GetLogs(ctx context.Context, input *service.GetDeliveryMonitorLogsInput) (service.DeliveryTriggerLogsPage, error) {
	return m.getLogsFn(ctx, input)
}

func newHandlerWithLstepDeliveryMonitorSvc(svc service.LstepDeliveryMonitorService) *Handler {
	return &Handler{svc: &service.Services{LstepDeliveryMonitor: svc}}
}
...
func TestToDeliveryTriggerSummaryResponse(t *testing.T) {
	tests := []struct {
		name  string
		input service.DeliveryTriggerSummary
...
func TestToDeliveryTriggerLogItemResponse(t *testing.T) {
	...
	tests := []struct {
		name string
		item *service.DeliveryTriggerLogItem
	}{
		{
...
func TestToDeliveryTriggerLogsPageResponse(t *testing.T) {
	tests := []struct {
		name string
		page service.DeliveryTriggerLogsPage
	}{
		{
			name: "converts page with items",
			page: service.DeliveryTriggerLogsPage{
				Items: []service.DeliveryTriggerLogItem{
...
func TestGetLstepDeliveryTriggerSummary(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			svc: &mockLstepDeliveryMonitorService{
				getSummaryFn: func(_ context.Context, input service.GetDeliveryMonitorSummaryInput) (service.DeliveryTriggerSummary, error) {
					assert.Equal(t, uint64(1), input.ClinicID)
					return service.DeliveryTriggerSummary{Scheduled: 5, Fired: 3}, nil
				},
			},
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockLstepDeliveryMonitorService{
				getSummaryFn: func(_ context.Context, _ service.GetDeliveryMonitorSummaryInput) (service.DeliveryTriggerSummary, error) {
					return service.DeliveryTriggerSummary{}, fmt.Errorf("db failure")
				},
			},
...
func TestGetLstepDeliveryTriggerLogs(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockLstepDeliveryMonitorService{
				getLogsFn: func(_ context.Context, input *service.GetDeliveryMonitorLogsInput) (service.DeliveryTriggerLogsPage, error) {
					assert.Equal(t, uint64(1), input.ClinicID)
					return service.DeliveryTriggerLogsPage{
						Items:   []service.DeliveryTriggerLogItem{{ID: 1, OwnerID: 2, ScheduledAt: time.Now()}},
						Total:   1,
						Page:    1,
						PerPage: 20,
					}, nil
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockLstepDeliveryMonitorService{
				getLogsFn: func(_ context.Context, _ *service.GetDeliveryMonitorLogsInput) (service.DeliveryTriggerLogsPage, error) {
					return service.DeliveryTriggerLogsPage{}, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
		},
