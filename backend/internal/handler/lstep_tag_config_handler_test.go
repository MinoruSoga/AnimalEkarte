...
type mockLstepTagConfigService struct {
	...
	createAutoManagedPrefixFn    func(ctx context.Context, input service.CreateAutoManagedPrefixInput) (*model.LstepAutoManagedPrefix, error)
	...
	createConditionTagMappingFn  func(ctx context.Context, input service.CreateConditionTagMappingInput) (*model.LstepConditionTagMapping, error)
	...
	createSendPurposeTagPrefixFn func(ctx context.Context, input service.CreateSendPurposeTagPrefixInput) (*model.LstepSendPurposeTagPrefix, error)
...
func (m *mockLstepTagConfigService) CreateAutoManagedPrefix(ctx context.Context, input service.CreateAutoManagedPrefixInput) (*model.LstepAutoManagedPrefix, error) {
...
func (m *mockLstepTagConfigService) CreateConditionTagMapping(ctx context.Context, input service.CreateConditionTagMappingInput) (*model.LstepConditionTagMapping, error) {
...
func (m *mockLstepTagConfigService) CreateSendPurposeTagPrefix(ctx context.Context, input service.CreateSendPurposeTagPrefixInput) (*model.LstepSendPurposeTagPrefix, error) {
...
func newLstepTagConfigRouter(svc service.LstepTagConfigService, permSvc service.EffectivePermissionService, setupCtx gin.HandlerFunc) *gin.Engine {
	h := &Handler{svc: &service.Services{LstepTagConfig: svc, EffectivePermission: permSvc}}
	r := gin.New()
...
func TestListAutoManagedPrefixes_Handler(t *testing.T) {
	...
	t.Run("403 no permission", func(t *testing.T) {
		r := newLstepTagConfigRouter(&mockLstepTagConfigService{}, &mockEffectivePermissionService{},
...
func TestCreateAutoManagedPrefix_Handler(t *testing.T) {
	...
	t.Run("201 created with location", func(t *testing.T) {
		r := newLstepTagConfigRouter(
			&mockLstepTagConfigService{
				createAutoManagedPrefixFn: func(_ context.Context, input service.CreateAutoManagedPrefixInput) (*model.LstepAutoManagedPrefix, error) {
...
func TestCreateConditionTagMapping_Handler(t *testing.T) {
	...
	t.Run("201 created", func(t *testing.T) {
		r := newLstepTagConfigRouter(
			&mockLstepTagConfigService{
				createConditionTagMappingFn: func(_ context.Context, input service.CreateConditionTagMappingInput) (*model.LstepConditionTagMapping, error) {
...
func TestCreateSendPurposeTagPrefix_Handler(t *testing.T) {
	...
	t.Run("201 created", func(t *testing.T) {
		r := newLstepTagConfigRouter(
			&mockLstepTagConfigService{
				createSendPurposeTagPrefixFn: func(_ context.Context, input service.CreateSendPurposeTagPrefixInput) (*model.LstepSendPurposeTagPrefix, error) {
