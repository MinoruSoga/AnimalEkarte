...
type mockProcedureService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateProcedureInput) (*model.Procedure, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateProcedureInput) (*model.Procedure, error)
...
func (m *mockProcedureService) Create(ctx context.Context, clinicID uint64, input *service.CreateProcedureInput) (*model.Procedure, error) {
	if m.createFn != nil {
...
func (m *mockProcedureService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateProcedureInput) (*model.Procedure, error) {
...
func newHandlerWithProcedureSvc(svc service.ProcedureService) *Handler {
	return &Handler{
		svc: &service.Services{Procedure: svc},
	}
}
...
func TestCreateProcedure(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockProcedureService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateProcedureInput) (*model.Procedure, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockProcedureService{
				createFn: func(_ context.Context, _ uint64, input *service.CreateProcedureInput) (*model.Procedure, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockProcedureService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateProcedureInput) (*model.Procedure, error) {
...
func TestUpdateProcedure(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockProcedureService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateProcedureInput) (*model.Procedure, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockProcedureService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateProcedureInput) (*model.Procedure, error) {
					return nil, apperrors.WrapNotFound("procedure", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteProcedureRouter(svc service.ProcedureService) *gin.Engine {
	r := gin.New()
...
func newReorderProceduresRouter(svc service.ProcedureService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithProcedureSvc(svc)
