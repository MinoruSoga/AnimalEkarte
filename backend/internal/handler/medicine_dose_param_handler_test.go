...
func newHandlerWithDoseParamSvc(svc service.MedicineDoseParamService) *Handler {
	return &Handler{svc: &service.Services{MedicineDoseParam: svc}}
}
...
func newDoseParamRouter(svc service.MedicineDoseParamService) *gin.Engine {
	r := gin.New()
