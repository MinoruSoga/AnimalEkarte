...
type mockVaccineService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateVaccineInput) (*model.Vaccine, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateVaccineInput) (*model.Vaccine, error)
...
func (m *mockVaccineService) Create(ctx context.Context, clinicID uint64, input *service.CreateVaccineInput) (*model.Vaccine, error) {
	return m.createFn(ctx, clinicID, input)
}
func (m *mockVaccineService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateVaccineInput) (*model.Vaccine, error) {
...
func newHandlerWithVaccineSvc(svc service.VaccineService) *Handler {
	return &Handler{
		svc: &service.Services{Vaccine: svc},
	}
}
...
func TestCreateVaccine(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockVaccineService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateVaccineInput) (*model.Vaccine, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockVaccineService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateVaccineInput) (*model.Vaccine, error) {
...
func TestUpdateVaccine(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockVaccineService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateVaccineInput) (*model.Vaccine, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockVaccineService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateVaccineInput) (*model.Vaccine, error) {
					return nil, apperrors.WrapNotFound("vaccine", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteVaccineRouter(svc service.VaccineService) *gin.Engine {
	r := gin.New()
...
func newReorderVaccinesRouter(svc service.VaccineService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithVaccineSvc(svc)
