...
type mockExamTypeService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateExamTypeInput) (*model.ExaminationType, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateExamTypeInput) (*model.ExaminationType, error)
...
func (m *mockExamTypeService) Create(ctx context.Context, clinicID uint64, input *service.CreateExamTypeInput) (*model.ExaminationType, error) {
	return m.createFn(ctx, clinicID, input)
}
func (m *mockExamTypeService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateExamTypeInput) (*model.ExaminationType, error) {
...
func TestCreateExaminationType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockExamTypeService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateExamTypeInput) (*model.ExaminationType, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockExamTypeService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateExamTypeInput) (*model.ExaminationType, error) {
...
func TestUpdateExaminationType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockExamTypeService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateExamTypeInput) (*model.ExaminationType, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockExamTypeService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateExamTypeInput) (*model.ExaminationType, error) {
					return nil, apperrors.WrapNotFound("exam_type", "999")
				},
			},
			wantStatus: http.StatusNotFound,
