...
type mockClosingSettingsService struct {
	getFn                 func(ctx context.Context, clinicID uint64) (*service.ClosingSettingsResponse, error)
	listSpecialPeriodsFn  func(ctx context.Context, clinicID uint64) ([]model.ClosingSpecialPeriod, error)
	updateStandardFn      func(ctx context.Context, clinicID uint64, input service.UpdateClinicSettingsInput) (*model.ClinicSettings, error)
	createSpecialPeriodFn func(ctx context.Context, clinicID uint64, input *service.CreateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error)
	updateSpecialPeriodFn func(ctx context.Context, clinicID, id uint64, input service.UpdateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error)
	deleteSpecialPeriodFn func(ctx context.Context, clinicID, id uint64) error
	resolveScheduleFn     func(ctx context.Context, clinicID uint64, date time.Time) (*service.DaySchedule, error)
}

func (m *mockClosingSettingsService) Get(ctx context.Context, clinicID uint64) (*service.ClosingSettingsResponse, error) {
...
func (m *mockClosingSettingsService) UpdateStandard(ctx context.Context, clinicID uint64, input service.UpdateClinicSettingsInput) (*model.ClinicSettings, error) {
	return m.updateStandardFn(ctx, clinicID, input)
}

func (m *mockClosingSettingsService) CreateSpecialPeriod(ctx context.Context, clinicID uint64, input *service.CreateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
	return m.createSpecialPeriodFn(ctx, clinicID, input)
}

func (m *mockClosingSettingsService) UpdateSpecialPeriod(ctx context.Context, clinicID, id uint64, input service.UpdateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
...
func (m *mockClosingSettingsService) ResolveSchedule(ctx context.Context, clinicID uint64, date time.Time) (*service.DaySchedule, error) {
	return m.resolveScheduleFn(ctx, clinicID, date)
}

func newHandlerWithClosingSettingsSvc(svc service.ClosingSettingsService) *Handler {
	return &Handler{svc: &service.Services{ClosingSettings: svc}}
}
...
func TestGetClosingSettings(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			svc: &mockClosingSettingsService{
				getFn: func(_ context.Context, clinicID uint64) (*service.ClosingSettingsResponse, error) {
					assert.Equal(t, uint64(1), clinicID)
					return &service.ClosingSettingsResponse{
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				getFn: func(_ context.Context, _ uint64) (*service.ClosingSettingsResponse, error) {
...
func TestUpdateClosingSettings(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				updateStandardFn: func(_ context.Context, clinicID uint64, input service.UpdateClinicSettingsInput) (*model.ClinicSettings, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				updateStandardFn: func(_ context.Context, _ uint64, _ service.UpdateClinicSettingsInput) (*model.ClinicSettings, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
...
func TestCreateSpecialPeriod(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				createSpecialPeriodFn: func(_ context.Context, clinicID uint64, input *service.CreateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				createSpecialPeriodFn: func(_ context.Context, _ uint64, _ *service.CreateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
...
func TestUpdateSpecialPeriod(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				updateSpecialPeriodFn: func(_ context.Context, clinicID, id uint64, input service.UpdateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockClosingSettingsService{
				updateSpecialPeriodFn: func(_ context.Context, _, _ uint64, _ service.UpdateSpecialPeriodInput) (*model.ClosingSpecialPeriod, error) {
...
func newDeleteSpecialPeriodRouter(svc service.ClosingSettingsService) *gin.Engine {
	r := gin.New()
