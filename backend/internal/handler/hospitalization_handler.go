...
func (h *Handler) ListHospitalizations(c *gin.Context) {
	...
	hospitalizations, total, err := h.svc.Hospitalization.List(c.Request.Context(), status, page, limit)
	if err != nil {
...
func (h *Handler) GetHospitalization(c *gin.Context) {
	...
	hospitalization, err := h.svc.Hospitalization.GetByID(c.Request.Context(), id)
	if err != nil {
...
func (h *Handler) DeleteHospitalization(c *gin.Context) {
	...
	if err := h.svc.Hospitalization.Delete(c.Request.Context(), id); err != nil {
		if apperrors.IsNotFound(err) {
			c.JSON(http.StatusNotFound, gin.H{"error": err.Error()})
			return
		}
