...
type mockExaminationService struct {
	...
	createFn       func(ctx context.Context, clinicID uint64, input *service.CreateExaminationInput) (*model.Examination, error)
...
func (m *mockExaminationService) Create(ctx context.Context, clinicID uint64, input *service.CreateExaminationInput) (*model.Examination, error) {
	return m.createFn(ctx, clinicID, input)
}

func (m *mockExaminationService) Update(ctx context.Context, clinicID, id uint64, input service.UpdateExaminationInput) (*model.Examination, error) {
...
func newHandlerWithExaminationSvc(svc service.ExaminationService) *Handler {
	return &Handler{svc: &service.Services{Examination: svc}}
}
