...
type mockCampaignService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateCampaignInput) (*model.Campaign, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateCampaignInput) (*model.Campaign, error)
...
func (m *mockCampaignService) Create(ctx context.Context, clinicID uint64, input *service.CreateCampaignInput) (*model.Campaign, error) {
	return m.createFn(ctx, clinicID, input)
}

func (m *mockCampaignService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateCampaignInput) (*model.Campaign, error) {
...
func newHandlerWithCampaignSvc(svc service.CampaignService) *Handler {
	return &Handler{svc: &service.Services{Campaign: svc}}
}
...
func TestCreateCampaign(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCampaignService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateCampaignInput) (*model.Campaign, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCampaignService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateCampaignInput) (*model.Campaign, error) {
...
func TestUpdateCampaign(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCampaignService{
				updateFn: func(_ context.Context, clinicID, id uint64, input *service.UpdateCampaignInput) (*model.Campaign, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCampaignService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateCampaignInput) (*model.Campaign, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCampaignService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateCampaignInput) (*model.Campaign, error) {
					return nil, apperrors.WrapNotFound("campaign", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newReorderCampaignsRouter(svc service.CampaignService) *gin.Engine {
	r := gin.New()
...
func newDeleteCampaignRouter(svc service.CampaignService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithCampaignSvc(svc)
