...
func (m *mockShiftTemplateService) Create(ctx context.Context, clinicID uint64, input *service.CreateShiftTemplateInput) (*model.ShiftTemplate, error) {
	if m.createFn != nil {
...
func (m *mockShiftTemplateService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateShiftTemplateInput) (*model.ShiftTemplate, error) {
	if m.updateFn != nil {
...
func newHandlerWithShiftTemplateSvc(svc service.ShiftTemplateService) *Handler {
	return &Handler{
...
func TestCreateShiftTemplate_Valid_Returns201(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockShiftTemplateService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateShiftTemplateInput) (*model.ShiftTemplate, error) {
					assert.Equal(t, uint64(1), clinicID)
...
func newDeleteShiftTemplateRouter(svc service.ShiftTemplateService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithShiftTemplateSvc(svc)
