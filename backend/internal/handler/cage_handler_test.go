...
type mockCageService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateCageInput) (*model.Cage, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateCageInput) (*model.Cage, error)
...
func (m *mockCageService) Create(ctx context.Context, clinicID uint64, input *service.CreateCageInput) (*model.Cage, error) {
	return m.createFn(ctx, clinicID, input)
}

func (m *mockCageService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateCageInput) (*model.Cage, error) {
...
func newHandlerWithCageSvc(svc service.CageService) *Handler {
	return &Handler{
		svc: &service.Services{Cage: svc},
	}
}
...
func TestCreateCage(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCageService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateCageInput) (*model.Cage, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCageService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateCageInput) (*model.Cage, error) {
...
func TestUpdateCage(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCageService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateCageInput) (*model.Cage, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockCageService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateCageInput) (*model.Cage, error) {
					return nil, apperrors.WrapNotFound("cage", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteCageRouter(svc service.CageService) *gin.Engine {
	r := gin.New()
...
func newReorderCagesRouter(svc service.CageService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithCageSvc(svc)
