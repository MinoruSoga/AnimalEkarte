...
// ---- mock TrimmingService ----

type mockTrimmingService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateTrimmingInput) (*model.Reservation, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateTrimmingInput) (*model.Reservation, error)
...
func (m *mockTrimmingService) GetByID(ctx context.Context, clinicID, id uint64) (*model.Reservation, error) {
	if m.getByIDFn != nil {
...
func (m *mockTrimmingService) Create(ctx context.Context, clinicID uint64, input *service.CreateTrimmingInput) (*model.Reservation, error) {
	if m.createFn != nil {
...
func (m *mockTrimmingService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateTrimmingInput) (*model.Reservation, error) {
	if m.updateFn != nil {
...
func newHandlerWithTrimmingSvc(svc service.TrimmingService) *Handler {
	return &Handler{svc: &service.Services{Trimming: svc}}
}
...
func TestCreateTrimming(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateTrimmingInput) (*model.Reservation, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateTrimmingInput) (*model.Reservation, error) {
...
func TestUpdateTrimming(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingService{
				updateFn: func(_ context.Context, _, id uint64, _ *service.UpdateTrimmingInput) (*model.Reservation, error) {
					return &model.Reservation{ID: id}, nil
				},
			},
			wantStatus: http.StatusOK,
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockTrimmingService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateTrimmingInput) (*model.Reservation, error) {
					return nil, apperrors.WrapNotFound("trimming", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteTrimmingRouter(svc service.TrimmingService) *gin.Engine {
	r := gin.New()
