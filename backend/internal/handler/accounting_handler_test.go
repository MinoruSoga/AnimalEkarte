...
type mockAccountingService struct {
	...
	createFn                    func(ctx context.Context, input *service.CreateAccountingInput) (*model.Billing, error)
	updateFn                    func(ctx context.Context, input *service.UpdateAccountingInput) (*model.Billing, error)
	correctCreditPaymentFn      func(ctx context.Context, input *service.CorrectCreditPaymentInput) (*model.Billing, error)
	...
	listUnpaidByOwnerFn         func(ctx context.Context, clinicID uint64, startDate, endDate string, page, limit int) ([]repository.UnpaidOwnerAggregate, int64, repository.UnpaidSummary, error)
	getOwnerUnpaidBalanceFn     func(ctx context.Context, clinicID, ownerID uint64) (repository.OwnerUnpaidBalance, error)
	getMonthlyUnpaidCarryoverFn func(ctx context.Context, clinicID uint64, year, month, page, limit int) ([]repository.MonthlyUnpaidOwnerPet, int64, repository.MonthlyUnpaidSummary, error)
	getDailySummaryFn           func(ctx context.Context, clinicID uint64, dateStr string) (*repository.DailySummaryResult, error)
	getDailySummaryForClinicsFn func(ctx context.Context, clinicIDs []uint64, dateStr string) ([]service.ClinicDailySummary, error)
}
...
func (m *mockAccountingService) Create(ctx context.Context, input *service.CreateAccountingInput) (*model.Billing, error) {
	return m.createFn(ctx, input)
}

func (m *mockAccountingService) Update(ctx context.Context, input *service.UpdateAccountingInput) (*model.Billing, error) {
	return m.updateFn(ctx, input)
}

func (m *mockAccountingService) CorrectCreditPayment(ctx context.Context, input *service.CorrectCreditPaymentInput) (*model.Billing, error) {
...
func (m *mockAccountingService) ListUnpaidByOwner(ctx context.Context, clinicID uint64, startDate, endDate string, page, limit int) ([]repository.UnpaidOwnerAggregate, int64, repository.UnpaidSummary, error) {
	return m.listUnpaidByOwnerFn(ctx, clinicID, startDate, endDate, page, limit)
}

func (m *mockAccountingService) GetOwnerUnpaidBalance(ctx context.Context, clinicID, ownerID uint64) (repository.OwnerUnpaidBalance, error) {
	return m.getOwnerUnpaidBalanceFn(ctx, clinicID, ownerID)
}

func (m *mockAccountingService) GetMonthlyUnpaidCarryover(ctx context.Context, clinicID uint64, year, month, page, limit int) ([]repository.MonthlyUnpaidOwnerPet, int64, repository.MonthlyUnpaidSummary, error) {
	return m.getMonthlyUnpaidCarryoverFn(ctx, clinicID, year, month, page, limit)
}

func (m *mockAccountingService) GetDailySummary(ctx context.Context, clinicID uint64, dateStr string) (*repository.DailySummaryResult, error) {
	return m.getDailySummaryFn(ctx, clinicID, dateStr)
}

func (m *mockAccountingService) GetDailySummaryForClinics(ctx context.Context, clinicIDs []uint64, dateStr string) ([]service.ClinicDailySummary, error) {
	return m.getDailySummaryForClinicsFn(ctx, clinicIDs, dateStr)
}

func newHandlerWithAccountingSvc(svc service.AccountingService) *Handler {
	return &Handler{svc: &service.Services{Accounting: svc}}
}
...
func TestCreateAccounting(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				createFn: func(_ context.Context, input *service.CreateAccountingInput) (*model.Billing, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				createFn: func(_ context.Context, _ *service.CreateAccountingInput) (*model.Billing, error) {
...
func TestCorrectCreditPayment(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			svc: &mockAccountingService{
				getByIDFn: func(_ context.Context, _, _ uint64) (*model.Billing, error) { return existing, nil },
				correctCreditPaymentFn: func(_ context.Context, input *service.CorrectCreditPaymentInput) (*model.Billing, error) {
		...
		},
		{
			...
			svc: &mockAccountingService{
				getByIDFn: func(_ context.Context, _, _ uint64) (*model.Billing, error) { return existing, nil },
				correctCreditPaymentFn: func(_ context.Context, _ *service.CorrectCreditPaymentInput) (*model.Billing, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			crSvc:      &stubCashRegisterIsClosed{isDateClosedFn: func(_ context.Context, _ uint64, _ time.Time) (bool, error) { return false, nil }},
...
func TestUpdateAccounting_Errors(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			accSvc: &stubAccountingPostClose{
				getByIDFn: func(_ context.Context, _, _ uint64) (*model.Billing, error) { return existing, nil },
				updateFn: func(_ context.Context, input *service.UpdateAccountingInput) (*model.Billing, error) {
					return &model.Billing{ID: input.ID, ClinicID: input.ClinicID}, nil
				},
			},
			crSvc:      &stubCashRegisterIsClosed{isDateClosedFn: func(_ context.Context, _ uint64, _ time.Time) (bool, error) { return false, nil }},
		...
		},
		{
			...
			accSvc: &stubAccountingPostClose{
				getByIDFn: func(_ context.Context, _, _ uint64) (*model.Billing, error) { return existing, nil },
				updateFn: func(_ context.Context, _ *service.UpdateAccountingInput) (*model.Billing, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			crSvc:      &stubCashRegisterIsClosed{isDateClosedFn: func(_ context.Context, _ uint64, _ time.Time) (bool, error) { return false, nil }},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			h := &Handler{svc: &service.Services{
				Accounting:          tt.accSvc,
				CashRegister:        tt.crSvc,
				EffectivePermission: &mockEffectivePermissionService{getEffectivePermissionsFn: perms},
			}}
...
func TestListUnpaidBillings(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				listUnpaidByOwnerFn: func(_ context.Context, _ uint64, _, _ string, _, _ int) ([]repository.UnpaidOwnerAggregate, int64, repository.UnpaidSummary, error) {
					return []repository.UnpaidOwnerAggregate{{OwnerID: 1, OwnerName: "田中太郎"}}, 1, repository.UnpaidSummary{}, nil
				},
			},
			wantStatus: http.StatusOK,
			wantBody:   `"owner_id":1`,
		...
		},
		{
			...
			svc: &mockAccountingService{
				listUnpaidByOwnerFn: func(_ context.Context, _ uint64, _, _ string, _, _ int) ([]repository.UnpaidOwnerAggregate, int64, repository.UnpaidSummary, error) {
					return nil, 0, repository.UnpaidSummary{}, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
		},
...
func TestGetOwnerUnpaidBalance(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getOwnerUnpaidBalanceFn: func(_ context.Context, clinicID, ownerID uint64) (repository.OwnerUnpaidBalance, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, uint64(5), ownerID)
					return repository.OwnerUnpaidBalance{TotalAmount: 3000, Count: 2}, nil
				},
			},
			wantStatus: http.StatusOK,
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getOwnerUnpaidBalanceFn: func(_ context.Context, _, _ uint64) (repository.OwnerUnpaidBalance, error) {
					return repository.OwnerUnpaidBalance{}, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
		},
...
func TestGetUnpaidMonthlySummary(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getMonthlyUnpaidCarryoverFn: func(_ context.Context, clinicID uint64, year, month, _, _ int) ([]repository.MonthlyUnpaidOwnerPet, int64, repository.MonthlyUnpaidSummary, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, 2026, year)
					assert.Equal(t, 6, month)
					return []repository.MonthlyUnpaidOwnerPet{{OwnerID: 1, OwnerName: "田中太郎"}}, 1, repository.MonthlyUnpaidSummary{}, nil
				},
			},
			wantStatus: http.StatusOK,
			wantBody:   `"owner_id":1`,
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getMonthlyUnpaidCarryoverFn: func(_ context.Context, _ uint64, _, _, _, _ int) ([]repository.MonthlyUnpaidOwnerPet, int64, repository.MonthlyUnpaidSummary, error) {
					return nil, 0, repository.MonthlyUnpaidSummary{}, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
		},
...
func TestGetDailySummary(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getDailySummaryFn: func(_ context.Context, clinicID uint64, dateStr string) (*repository.DailySummaryResult, error) {
					assert.Equal(t, uint64(1), clinicID)
					assert.Equal(t, "2026-06-01", dateStr)
					return &repository.DailySummaryResult{BillingCount: 3, GrandTotal: 9000}, nil
				},
			},
			wantStatus: http.StatusOK,
		...
		},
		{
			...
			svc: &mockAccountingService{
				getDailySummaryForClinicsFn: func(_ context.Context, clinicIDs []uint64, dateStr string) ([]service.ClinicDailySummary, error) {
					assert.Equal(t, []uint64{1, 2}, clinicIDs)
					assert.Equal(t, "2026-06-01", dateStr)
					return []service.ClinicDailySummary{{ClinicID: 1, Summary: &repository.DailySummaryResult{GrandTotal: 100}}}, nil
				},
			},
			wantStatus: http.StatusOK,
			wantBody:   `"clinic_id":1`,
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockAccountingService{
				getDailySummaryFn: func(_ context.Context, _ uint64, _ string) (*repository.DailySummaryResult, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
		},
		{
			...
			svc: &mockAccountingService{
				getDailySummaryForClinicsFn: func(_ context.Context, _ []uint64, _ string) ([]service.ClinicDailySummary, error) {
					return nil, fmt.Errorf("db failure")
				},
			},
			wantStatus: http.StatusInternalServerError,
...
func newCancelAccountingRouter(svc service.AccountingService) *gin.Engine {
	r := gin.New()
