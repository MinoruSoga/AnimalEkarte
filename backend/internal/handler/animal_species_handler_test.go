...
type mockAnimalSpeciesService struct {
	...
	createFn  func(ctx context.Context, input *service.CreateAnimalSpeciesInput) (*model.AnimalSpecies, error)
	updateFn  func(ctx context.Context, id uint64, input *service.UpdateAnimalSpeciesInput) (*model.AnimalSpecies, error)
...
func (m *mockAnimalSpeciesService) Create(ctx context.Context, input *service.CreateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
	return m.createFn(ctx, input)
}

func (m *mockAnimalSpeciesService) Update(ctx context.Context, id uint64, input *service.UpdateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
...
func newHandlerWithAnimalSpeciesSvc(svc service.AnimalSpeciesService) *Handler {
	return &Handler{
		svc: &service.Services{AnimalSpecies: svc},
	}
}
...
func TestCreateAnimalSpecies(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			body: validBody(),
			svc: &mockAnimalSpeciesService{
				createFn: func(_ context.Context, input *service.CreateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
		...
		},
		{
			...
			body: validBody(),
			svc: &mockAnimalSpeciesService{
				createFn: func(_ context.Context, _ *service.CreateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
...
func TestUpdateAnimalSpecies(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			svc: &mockAnimalSpeciesService{
				updateFn: func(_ context.Context, id uint64, input *service.UpdateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
		...
		},
		{
			...
			body:    map[string]any{"name": "テスト"},
			svc: &mockAnimalSpeciesService{
				updateFn: func(_ context.Context, _ uint64, _ *service.UpdateAnimalSpeciesInput) (*model.AnimalSpecies, error) {
					return nil, apperrors.WrapNotFound("animal_species", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteAnimalSpeciesRouter(svc service.AnimalSpeciesService) *gin.Engine {
	r := gin.New()
...
func newReorderAnimalSpeciesRouter(svc service.AnimalSpeciesService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithAnimalSpeciesSvc(svc)
