...
type mockDiagnosisTypeService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateDiagnosisTypeInput) (*model.DiagnosisType, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateDiagnosisTypeInput) (*model.DiagnosisType, error)
...
func (m *mockDiagnosisTypeService) Create(ctx context.Context, clinicID uint64, input *service.CreateDiagnosisTypeInput) (*model.DiagnosisType, error) {
	return m.createFn(ctx, clinicID, input)
}
func (m *mockDiagnosisTypeService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateDiagnosisTypeInput) (*model.DiagnosisType, error) {
...
func (m *mockDiagnosisNameService) Create(ctx context.Context, clinicID uint64, input *service.CreateDiagnosisNameInput) (*model.DiagnosisName, error) {
	return m.createFn(ctx, clinicID, input)
}
func (m *mockDiagnosisNameService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateDiagnosisNameInput) (*model.DiagnosisName, error) {
	return m.updateFn(ctx, clinicID, id, input)
}
...
func newHandlerWithDiagnosisSvc(typeSvc service.DiagnosisTypeService, nameSvc service.DiagnosisNameService) *Handler {
	return &Handler{
		svc: &service.Services{
			DiagnosisType: typeSvc,
			DiagnosisName: nameSvc,
		},
	}
}
...
func TestCreateDiagnosisType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			typeSvc: &mockDiagnosisTypeService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateDiagnosisTypeInput) (*model.DiagnosisType, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			typeSvc: &mockDiagnosisTypeService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateDiagnosisTypeInput) (*model.DiagnosisType, error) {
...
func TestUpdateDiagnosisType(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			typeSvc: &mockDiagnosisTypeService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateDiagnosisTypeInput) (*model.DiagnosisType, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			typeSvc: &mockDiagnosisTypeService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateDiagnosisTypeInput) (*model.DiagnosisType, error) {
					return nil, apperrors.WrapNotFound("diagnosis_type", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteDiagnosisTypeRouter(typeSvc service.DiagnosisTypeService) *gin.Engine {
	r := gin.New()
...
func newReorderDiagnosisTypesRouter(typeSvc service.DiagnosisTypeService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithDiagnosisSvc(typeSvc, &mockDiagnosisNameService{})
...
func TestCreateDiagnosisName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			nameSvc: &mockDiagnosisNameService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateDiagnosisNameInput) (*model.DiagnosisName, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			nameSvc: &mockDiagnosisNameService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateDiagnosisNameInput) (*model.DiagnosisName, error) {
...
func TestUpdateDiagnosisName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			nameSvc: &mockDiagnosisNameService{
				updateFn: func(_ context.Context, _, _ uint64, input *service.UpdateDiagnosisNameInput) (*model.DiagnosisName, error) {
					require.NotNil(t, input.Name)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			nameSvc: &mockDiagnosisNameService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateDiagnosisNameInput) (*model.DiagnosisName, error) {
					return nil, apperrors.WrapNotFound("diagnosis_name", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteDiagnosisNameRouter(nameSvc service.DiagnosisNameService) *gin.Engine {
	r := gin.New()
...
func newReorderDiagnosisNamesRouter(nameSvc service.DiagnosisNameService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithDiagnosisSvc(&mockDiagnosisTypeService{}, nameSvc)
