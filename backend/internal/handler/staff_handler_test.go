...
func (m *mockStaffService) Create(ctx context.Context, input *service.CreateStaffInput) (*model.Staff, error) {
	if m.createFn != nil {
...
func (m *mockStaffService) CreateWithAccount(ctx context.Context, input *service.CreateStaffWithAccountInput) (*model.Staff, error) {
...
func (m *mockStaffService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateStaffInput) (*model.Staff, error) {
	if m.updateFn != nil {
...
func (m *mockStaffService) GetExcludedReservationTypeIDs(ctx context.Context, staffID uint64) ([]uint64, error) {
	if m.getExcludedReservationTypesFn != nil {
		return m.getExcludedReservationTypesFn(ctx, staffID)
	}
	return nil, nil
}
...
func newHandlerWithStaffSvc(staffSvc service.StaffService) *Handler {
	return &Handler{
...
func TestCreateStaff_Valid_Returns201(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockStaffService{
				createFn: func(_ context.Context, input *service.CreateStaffInput) (*model.Staff, error) {
...
func newDeleteStaffRouter(staffSvc service.StaffService) *gin.Engine {
	r := gin.New()
