...
type mockReservationTypeGroupService struct {
	...
	createFn  func(ctx context.Context, clinicID uint64, input *service.CreateReservationTypeGroupInput) (*model.ReservationTypeGroup, error)
	updateFn  func(ctx context.Context, clinicID, id uint64, input *service.UpdateReservationTypeGroupInput) (*model.ReservationTypeGroup, error)
...
func (m *mockReservationTypeGroupService) Create(ctx context.Context, clinicID uint64, input *service.CreateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
	if m.createFn != nil {
...
func (m *mockReservationTypeGroupService) Update(ctx context.Context, clinicID, id uint64, input *service.UpdateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
	if m.updateFn != nil {
...
func newHandlerWithReservationTypeGroupSvc(svc service.ReservationTypeGroupService) *Handler {
	return &Handler{svc: &service.Services{ReservationTypeGroup: svc}}
}
...
func TestCreateReservationTypeGroup(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockReservationTypeGroupService{
				createFn: func(_ context.Context, clinicID uint64, input *service.CreateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
					assert.Equal(t, uint64(1), clinicID)
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockReservationTypeGroupService{
				createFn: func(_ context.Context, _ uint64, _ *service.CreateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
...
func TestUpdateReservationTypeGroup(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockReservationTypeGroupService{
				updateFn: func(_ context.Context, _, id uint64, input *service.UpdateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
		...
		},
		{
			...
			setupCtx: func(c *gin.Context) { setClinicID(c) },
			svc: &mockReservationTypeGroupService{
				updateFn: func(_ context.Context, _, _ uint64, _ *service.UpdateReservationTypeGroupInput) (*model.ReservationTypeGroup, error) {
					return nil, apperrors.WrapNotFound("reservation_type_group", "999")
				},
			},
			wantStatus: http.StatusNotFound,
...
func newDeleteReservationTypeGroupRouter(svc service.ReservationTypeGroupService) *gin.Engine {
	r := gin.New()
...
func newReorderReservationTypeGroupsRouter(svc service.ReservationTypeGroupService) *gin.Engine {
	r := gin.New()
	h := newHandlerWithReservationTypeGroupSvc(svc)
