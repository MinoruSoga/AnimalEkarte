...
type medicalRecordRepositories struct {
	...
	labDeviceItemMasters    medicalrecord.LabDeviceItemMasterRepository
	labDeviceReceive        medicalrecord.LabDeviceReceiveRepository
...
func newMedicalRecordRepositories(db *gorm.DB) medicalRecordRepositories {
	return medicalRecordRepositories{
		...
		labDeviceItemMasters:    medicalrecord.NewLabDeviceItemMasterRepository(db),
		labDeviceReceive:        medicalrecord.NewLabDeviceReceiveRepository(db),
